...
class SiderCustom extends Component {
    ...
    setMenuOpen = props => {
        ...
        this.setState({
            ...
            selectedKey: '/background/'+pathname.split('/')[2]
        },function () {
        });
    };
            ...
            >
                ...
                >
                    <Menu.Item key="/background/">
                        <Link to={'/background/'}><Icon type="mobile" /><span className="nav-text">首页</span></Link>
                    </Menu.Item>
                    <Menu.Item key="/background/config">
                        <Link to={'/background/config'}><Icon type="scan" /><span className="nav-text">网站基本配置</span></Link>
                    </Menu.Item>
                    <Menu.Item key="/background/products">
